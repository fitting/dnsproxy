package org.fitting.dnsproxy.server;
...
import static org.fitting.dnsproxy.server.Session.SC_CLIENT_ERROR;
import static org.fitting.dnsproxy.server.Session.SC_CONNECTING_TO_HOST;
import static org.fitting.dnsproxy.server.Session.SC_CONNECTION_CLOSED;
import static org.fitting.dnsproxy.server.Session.SC_FILE_REQUEST;
import static org.fitting.dnsproxy.server.Session.SC_HOST_NOT_FOUND;
import static org.fitting.dnsproxy.server.Session.SC_INTERNAL_SERVER_ERROR;
import static org.fitting.dnsproxy.server.Session.SC_NOT_SUPPORTED;
import static org.fitting.dnsproxy.server.Session.SC_OK;
import static org.fitting.dnsproxy.server.SessionUtils.CONTENT_LENGTH;
import static org.fitting.dnsproxy.server.SessionUtils.COOKIE;
import static org.fitting.dnsproxy.server.SessionUtils.PROXY_CONNECTION;
import static org.fitting.dnsproxy.server.SessionUtils.REFERER;
import static org.fitting.dnsproxy.server.SessionUtils.USER_AGENT;
import static org.fitting.dnsproxy.server.SessionUtils.httpMethodId;
